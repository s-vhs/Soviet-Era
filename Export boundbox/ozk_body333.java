...
public class ozk_body2 extends EntityModel<Entity> {
	...
	public ozk_body2() {
		...
		ozk_left_sleeve.setTextureOffset(38, 13).addBox(4.0F, -9.0F, -1.5F, 4.0F, 12.0F, 1.0F, 0.0F, false);
		ozk_left_sleeve.setTextureOffset(20, 37).addBox(4.0F, -9.0F, 3.5F, 4.0F, 12.0F, 1.0F, 0.0F, false);
		ozk_left_sleeve.setTextureOffset(28, 16).addBox(8.0F, -9.0F, -0.5F, 1.0F, 12.0F, 4.0F, 0.0F, false);
		ozk_left_sleeve.setTextureOffset(10, 28).addBox(3.0F, -9.0F, -0.5F, 1.0F, 12.0F, 4.0F, 0.0F, false);
		ozk_left_sleeve.setTextureOffset(0, 44).addBox(4.0F, -10.0F, -0.5F, 4.0F, 1.0F, 4.0F, 0.0F, false);
		ozk_left_sleeve.setTextureOffset(40, 39).addBox(4.0F, 3.0F, -0.5F, 4.0F, 1.0F, 4.0F, 0.0F, false);

		ozk_right_sleeve = new ModelRenderer(this);
		ozk_right_sleeve.setRotationPoint(-12.0F, 24.0F, 0.0F);
		ozk_right_sleeve.setTextureOffset(40, 34).addBox(4.0F, -10.0F, -0.5F, 4.0F, 1.0F, 4.0F, 0.0F, false);
		ozk_right_sleeve.setTextureOffset(38, 29).addBox(4.0F, 3.0F, -0.5F, 4.0F, 1.0F, 4.0F, 0.0F, false);
		ozk_right_sleeve.setTextureOffset(30, 37).addBox(4.0F, -9.0F, 3.5F, 4.0F, 12.0F, 1.0F, 0.0F, false);
		ozk_right_sleeve.setTextureOffset(0, 26).addBox(3.0F, -9.0F, -0.5F, 1.0F, 12.0F, 4.0F, 0.0F, false);
		ozk_right_sleeve.setTextureOffset(38, 0).addBox(4.0F, -9.0F, -1.5F, 4.0F, 12.0F, 1.0F, 0.0F, false);
		ozk_right_sleeve.setTextureOffset(28, 0).addBox(8.0F, -9.0F, -0.5F, 1.0F, 12.0F, 4.0F, 0.0F, false);
	}
