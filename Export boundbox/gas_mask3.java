...
public class gas_mask extends EntityModel<Entity> {
	...
	public gas_mask() {
		...
		mask.setTextureOffset(28, 16).addBox(1.0F, -5.0F, 0.4375F, 2.0F, 2.0F, 0.0F, 0.0F, false);
		mask.setTextureOffset(28, 16).addBox(-3.0F, -5.0F, 0.4375F, 2.0F, 2.0F, 0.0F, 0.0F, false);

		cube_r1 = new ModelRenderer(this);
		cube_r1.setRotationPoint(3.5581F, -1.75F, -0.2348F);
