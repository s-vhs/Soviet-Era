...
import ru.tesmio.blocks.baseblock.BlockSideNoDropsCustomModel;
import ru.tesmio.utils.VoxelShapeUtil;

import javax.annotation.Nullable;
import java.util.List;

public class WindProofPanel extends BlockSideNoDropsCustomModel {
    String info;
    ...
    final VoxelShape SHAPE[] = new VoxelShape[] {
