...
public class TabletScreen extends Screen {
    private final TabletTileEntity tileSign;
    private int updateCounter;
    private int editLine;
    private TextInputUtil textInputUtil;
    private final String[] lines;

    public TabletScreen(TabletTileEntity teSign) {
        super(new TranslationTextComponent("sign.edit"));
        this.lines = IntStream.range(0, 4).mapToObj(teSign::getText).map(ITextComponent::getString).toArray(String[]::new);
    ...
    protected void init() {
        ...
        this.textInputUtil = new TextInputUtil(() -> this.lines[this.editLine], (text) -> {
            this.lines[this.editLine] = text;
    ...
    public void onClose() {
        ...
        if (clientplaynethandler != null) {
               ...
               NetworkHandler.CHANNEL.sendToServer(new PacketTabletUpdate(this.tileSign.getPos(), this.lines[0], this.lines[1], this.lines[2], this.lines[3]));
            //clientplaynethandler.sendPacket(new CUpdateSignPacket(this.tileSign.getPos(), this.lines[0], this.lines[1], this.lines[2], this.lines[3]));
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        for(int i1 = 0; i1 < this.lines.length; ++i1) {
            ...
            if (s != null) {
                ...
                this.minecraft.fontRenderer.drawBidiString(s, f3, (float)(i1 * 10 - this.lines.length * 5), i, false, matrix4f, irendertypebuffer$impl, false, 0, 15728880, false);
