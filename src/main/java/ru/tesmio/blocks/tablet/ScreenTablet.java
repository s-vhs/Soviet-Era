...
public class ScreenTablet extends Screen {
    private static final ResourceLocation TABLET_GUI = new ResourceLocation(Core.MODID,
            "textures/gui/tablet_screen.png");

    private final TileEntityTablet tileSign;
    ...
    public ScreenTablet(TileEntityTablet teSign) {
