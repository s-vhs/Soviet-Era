...
public class BlockSideNoDropsCustomModel extends BlockSideNoDrops implements IWaterLoggable {
    public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;
    private float shadingInside;
    public static VoxelShape FACING_SHAPE = VoxelShapes.fullCube();
    public BlockSideNoDropsCustomModel(Properties properties, float shadingInside) {
        super(properties);
        this.shadingInside = shadingInside;
        this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH).with(WATERLOGGED, Boolean.valueOf(false)));
    }
    public BlockSideNoDropsCustomModel(float shadingInside) {
