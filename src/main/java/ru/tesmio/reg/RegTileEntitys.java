...
public class RegTileEntitys {
    ...
    public static final RegistryObject<TileEntityType<TabletTileEntity>> TABLET_TE = TILE_ENTITY_TYPES
            .register("tablet_te2",
                    () -> TileEntityType.Builder.create(TabletTileEntity::new, RegBlocks.TABLET.get()).build(null));
