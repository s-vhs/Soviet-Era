...
public class RegFluids {
    ...
    public static final RegistryObject<FlowingFluid> TOXIC_WATER
            = FLUIDS.register("toxic_water_fluid", () -> new ForgeFlowingFluid.Source(RegFluids.OIL_PROPERTIES));

    public static final RegistryObject<FlowingFluid> TOXIC_WATER_FLOWING
            = FLUIDS.register("toxic_water_flowing", () -> new ForgeFlowingFluid.Flowing(RegFluids.OIL_PROPERTIES));
    ...
    public static final RegistryObject<FlowingFluidBlock> TOXIC_WATER_BLOCK = RegBlocks.BLOCKS.register("toxic_water",
            () -> new FlowingFluidBlock(() -> RegFluids.TOXIC_WATER.get(), AbstractBlock.Properties.create(Material.WATER)
